...
class HumanPlayer:
    ...
    def take_turn(self):
        ...
        print(self.player_name + " have launched: ", self.attackNum, "of attacks")
        print(self.player_name + " hit number is: ", self.hitNum)
        print(self.player_name + " miss number is: ", self.missNum)
...
class ComputerPlayer:
    ...
    def position_fleet(self):
        ...
        # Confirm the final board to the user now that the positioning is done.
        print("The computer's fleet is ready to play.")
    ...
    def position_boat(self, boat):
        ...
        # Let the computer randomly generate boat position
        x = random.randint(0, 9)
        y = random.randint(0, 9)
        boat.set_orientation(comp_orientation)
        boat.set_position(x, y)
    ...
    def take_turn(self):
        ...
        # Get attack position. Avoid grids which have already been hit
        x = random.randint(0, 9)
        y = random.randint(0, 9)
        while self.board.grid[y][x] != " B" and self.board.grid[y][x] != " _":
            x = random.randint(0, 9)
            y = random.randint(0, 9)
        ...
        if hit_flag:
            print()
            print("Computer hit a boat at: (", str(x), ",", str(y), ")")
            self.hitNum += 1
            print()
        else:
            print()
            print("Computer missed at: (", str(x), ",", str(y), ")")
            self.missNum += 1
            print()
